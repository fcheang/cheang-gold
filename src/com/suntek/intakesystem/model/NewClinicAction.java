...
public class NewClinicAction extends Action {

    public NewClinicAction(Model model){
    	super(model);
    }

    public String getName(){
    	return "NewClinicAction.do";
    }
    ...
    public String perform(HttpServletRequest req){
        ...
        String retPage;
        try{
            model.insertClinic(name, streetAddress, state, city, zipcode,
                pn1, pn2, fax, notes);
            retPage = successPage;
        }catch(Throwable e){
            success = false;
        ...
        if (success){
            session.setAttribute("message",
                "<font color=\"blue\"><b>Clinic <em>"+name+"</em> was created successfully!</b></font>");
        }else{
            session.setAttribute("message",
                "<font color=\"red\"><b>Problem create Clinic <em>"+name+"</em>!</b></font>");
