 ...
 * @version 1.0
 */
public class NoShowsReportAction extends Action {

    public NoShowsReportAction(Model m){
        super(m);
    }
    ...
    public String perform(HttpServletRequest req) {
        ...
        try{
            ...
            message += "<p align=\"center\">"+
                ...
                "<th width=5%><strong># NoShows</strong></th>\n"+
                "</tr>\n";

            List list = model.getNoShowsSummary(esd, eed);
            ...
            message += "<p align=\"center\">NoShows Detail:";
            ...
            list = model.getNoShowsDetail(esd, eed);
